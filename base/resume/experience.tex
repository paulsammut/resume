  ...
  \cventry
    ...
    {2017 - 2018} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {\href{http://bit.ly/2T3Kvvs}{Built a tech-demo street robot name Primo using ROS capable of operating autonomously in the street.}}
        \item {\href{http://bit.ly/2TjikYy}{Integrated multiple stereo cams, mono cams, IMU and other sensors to provide odometry fused with an EKF.}}
        \item {Integrated RTAB-Map appearance based SLAM to create maps and localize within them.}
      \end{cvitems}
    }
