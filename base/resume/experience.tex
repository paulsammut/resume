...
%---------------------------------------------------------
  \cventry
    ...
    {AWS} % Organization
    {Las Vegas NV (Remote)} % Location
    {Nov 2020 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Wrote Cloud configurable edge software that runs in vehicles and collects customer defined data for OEMs.}
        \item {Designed Cloud/Edge systems that handle bi-directional communication to vehicles. Control/Data plane.}
        \item {Designed a simulation system that creates virtual vehicles and runs automated Cloud/Edge E2E tests.}
      \end{cvitems}
    }
  ...
  \cventry
    ...
    {2012 - 2016} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Designed PCBA and wrote firmware for 16bit uProc based hardware product.}
      \end{cvitems}
    }
