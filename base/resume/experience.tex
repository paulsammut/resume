  ...
  \cventry
    ...
    {August 2019 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Mentored junior team members and aided them in owning design projects by guiding development path and establishing priorities.}
        \item {Owned mechanical design of IP68 environmental sealing system with 3 discreet electronics enclosure chambers and 6 electrical passthroughs.}
        ...
        \item {Designed in CAD assembly fixtures to speed up and scale fabrication and assembly operations of scooters.}
